	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					Generated with <a href="http://hitchwiki.org/maps/">Hitchwiki Maps</a>. This XSLT template is released under GPL and is based on work for <a href="http://www.arnebrachhold.de/redir/sitemap-home/">Google Sitemap Generator Plugin for WordPress</a> by <a href="http://www.arnebrachhold.de/">Arne Brachhold</a>.
				</div>
			</body>
		</html>
	</xsl:template>
