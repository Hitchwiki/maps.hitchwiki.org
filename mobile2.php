...
$settings["mobile_url"] = 'http://hitchwiki.org/devmaps/m2';
...
<head>
	...
	<script src="<?php echo $settings["base_url"]; ?>/static/js/jquery.mobile.min.js?c=<?php echo $settings["cache_buster"]; ?>"></script>
	
	<link rel="stylesheet" href="<?php echo $settings["base_url"]; ?>/static/css/jquery.mobile/jquery.mobile.min.css?c=<?php echo $settings["cache_buster"]; ?>" />
	<link rel="stylesheet" href="<?php echo $settings["base_url"]; ?>/static/css/main.mobile2.css?c=<?php echo $settings["cache_buster"]; ?>" />

	<script src="<?php echo $settings["base_url"]; ?>/static/js/main.mobile2.js?c=<?php echo $settings["cache_buster"]; ?>"></script>
...
<body>
	...
	<?php
		...
		include("views/mobile2/".$page.".php");
	?>
