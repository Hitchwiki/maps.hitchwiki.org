...
SOURCE_STRINGS = [
    ...
    "Staying on the road? Sign up to Trustroots and look for hosts along your route",
    "Share",
    "Share my ride",
    ...
    "No worries — what made you say that?",
    "No, I would not accept this ride again",
    "Camping tonight? Log the spot on campwild.org so the next hitchhiker finds it",
    "Origin country",
