...
<head>
	...
	/*
	 * Map Services
	 * You need to enable these from init_map() in static/mobile/js/main.mobile.js 
	...
	<script>
	    ...
	    /*
	     * Translate jquery.mobile default strings
	     * Must appear before jquery.mobile.min.js but after jquery.min.js
	     */
		$(document).bind("mobileinit", function(){
		  $.extend(  $.mobile , {
		    loadingMessage: "<?php echo _("Loading..."); ?>",
		    pageLoadErrorMessage: "<?php echo _("Error"); ?>",
	...
	<script src="<?php echo $settings["base_url"]; ?>/static/mobile/js/jquery.mobile.min.js?c=<?php echo $settings["cache_buster"]; ?>"></script>
	
	<link rel="stylesheet" href="<?php echo $settings["base_url"]; ?>/static/mobile/css/jquery.mobile.min.css?c=<?php echo $settings["cache_buster"]; ?>" />
	<link rel="stylesheet" href="<?php echo $settings["base_url"]; ?>/static/mobile/css/main.mobile.css?c=<?php echo $settings["cache_buster"]; ?>" />

	<script src="<?php echo $settings["base_url"]; ?>/static/mobile/js/main.mobile.js?c=<?php echo $settings["cache_buster"]; ?>"></script>
